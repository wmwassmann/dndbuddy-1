...
var mhra = [
	...
	'assets/images-male/human-ranger-3.png',
];
var mhm = [
	'assets/images-male/human-mage-1.png',
	'assets/images-male/human-mage-2.png',
	'assets/images-male/human-mage-3.png',
];
var mhc = [
...
var mhro = [
	...
	'assets/images-male/human-rogue-3.png',
];
var fhf = [
	'assets/images-female/human-fighter-1.png',
	'assets/images-female/human-fighter-2.png',
	'assets/images-female/human-fighter-3.png',
];
var fhra = [
	'assets/images-female/human-ranger-1.png',
	'assets/images-female/human-ranger-2.png',
	'assets/images-female/human-ranger-3.png',
];
var fhm = [
	'assets/images-female/human-mage-1.png',
	'assets/images-female/human-mage-2.png',
	'assets/images-female/human-mage-3.png',
];
var fhc = [
	'assets/images-female/human-cleric-1.png',
	'assets/images-female/human-cleric-2.png',
	'assets/images-female/human-cleric-3.png',
];
var fhro = [
	'assets/images-female/human-rogue-1.png',
	'assets/images-female/human-rogue-2.png',
	'assets/images-female/human-rogue-3.png',
];
var mef = [
...
var fera = [
	...
	'assets/images-female/elf-ranger-2.png',
	'assets/images-female/elf-ranger-3.png',
];
var mem = [
...
var fem = [
	...
	'assets/images-female/elf-mage-2.png',
	'assets/images-female/elf-mage-3.png',
];
var mec = [
...
var fec = [
	'assets/images-female/elf-cleric-1.png',
	'assets/images-female/elf-cleric-2.png',
	'assets/images-female/elf-cleric-3.png',
];
var mero = [
	'assets/images-male/elf-rogue-1.png',
	'assets/images-male/elf-rogue-2.png',
	'assets/images-male/elf-rogue-3.png',
];
var fero = [
	'assets/images-female/elf-rogue-1.png',
	'assets/images-female/elf-rogue-2.png',
	'assets/images-female/elf-rogue-3.png',
];
var mdf = [
	'assets/images-male/dwarf-fighter-1.png',
	'assets/images-male/dwarf-fighter-2.png',
	'assets/images-male/dwarf-fighter-3.png',
];
var fdf = [
	'assets/images-female/dwarf-fighter-1.png',
	'assets/images-female/dwarf-fighter-2.png',
	'assets/images-female/dwarf-fighter-3.png',
];
var mdra = [
	'assets/images-male/dwarf-ranger-1.png',
	'assets/images-male/dwarf-ranger-2.png',
	'assets/images-male/dwarf-ranger-3.png',
];
var fdra = [
	'assets/images-female/dwarf-ranger-1.png',
	'assets/images-female/dwarf-ranger-2.png',
	'assets/images-female/dwarf-ranger-3.png',
];
var mdm = [
	'assets/images-male/dwarf-mage-1.png',
	'assets/images-male/dwarf-mage-2.png',
	'assets/images-male/dwarf-mage-3.png',
];
var fdm = [
	'assets/images-female/dwarf-mage-1.png',
	'assets/images-female/dwarf-mage-2.png',
	'assets/images-female/dwarf-mage-3.png',
];
var mdc = [
	'assets/images-male/dwarf-cleric-1.png',
	'assets/images-male/dwarf-cleric-2.png',
	'assets/images-male/dwarf-cleric-3.png',
];
var fdc = [
	'assets/images-female/dwarf-cleric-1.png',
	'assets/images-female/dwarf-cleric-2.png',
...
var fdro = [
	...
	'assets/images-female/dwarf-rogue-2.png',
	'assets/images-female/dwarf-rogue-3.png',
];
